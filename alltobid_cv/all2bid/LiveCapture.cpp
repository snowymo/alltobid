...
LiveCapture::LiveCapture()
{
	...
	cv::setMouseCallback("live", LiveCapture::selectAOI, 0);
...
cv::Mat LiveCapture::generateLive()
{	
...
void LiveCapture::translate2num(std::map<int, int> digit)
{
	result = 0;
...
int LiveCapture::cmp2source(cv::Mat input, int child)
{
...
int LiveCapture::checkChildren(std::vector<cv::Vec4i> hierachy, int idx)
{
	int childCnt = 0;
	if (hierachy[idx][2] < 0)
		return 0;
...
void LiveCapture::selectAOI(int event, int x, int y, int flags, void* userdata)
{
